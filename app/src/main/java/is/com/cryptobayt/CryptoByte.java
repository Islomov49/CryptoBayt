...
public class CryptoByte extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etChoiseKey = (EditText) findViewById(R.id.etChoiseKey);
        createRoom = (TextView) findViewById(R.id.createRoom);
        tvSearchRoom = (TextView) findViewById(R.id.tvSearchRoom);
